...
public class SecuritySchemeIOTest extends IndexScannerTestBase {
...
//        SecuritySchemeIO<?, ?, ?, ?, ?> securitySchemeIO = ioContext.securitySchemeIO();
//        org.eclipse.microprofile.openapi.models.security.SecurityScheme scheme = securitySchemeIO.read(annotation);
    }
